            ...
            <form action="/cadastrar-produto" method="POST">
                ...
                <div class="flex flex-col mt-6 h-full">
                    <div>
                        ...
                        <input type="text" name="nome" class="h-8 w-full rounded-sm border-b-2 border-indigo-500 bg-white">
                        <span class="my-2 text-lg">Valor</span>
                        <input type="text" name="valor" class="h-8 w-full rounded-sm border-b-2 border-indigo-500 bg-white">
